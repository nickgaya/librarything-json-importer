...
class LibraryThingScraper(LibraryThingRobot):
    ...
    def is_summary_autogenerated(self):
        """Determine whether summary is autogerated"""
        elt = self.driver.find_element_by_id('bookedit_summary')
        autogen = 'autogeneratedText' in get_class_list(elt)
        logger.debug("Found summary autogenerated: %r", autogen)
        return autogen
    ...
    def process_book(self, book_id, book_data):
        ...
        # Get whether summary is autogenerated
        extra['summary_autogenerated'] = self.is_summary_autogenerated()
